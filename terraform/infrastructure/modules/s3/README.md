...
|------|-------------|------|---------|:--------:|
| <a name="input_cors_allowed_origins"></a> [cors\_allowed\_origins](#input\_cors\_allowed\_origins) | Set of origins from which the bucket can be accessed | `list(string)` | `[]` | no |
