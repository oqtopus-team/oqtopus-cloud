...
| <a name="input_storage_env_vars_s3"></a> [storage\_env\_vars\_s3](#input\_storage\_env\_vars\_s3) | The Lambda environment variables for S3 storage drivder. | <pre>object({<br>    STORAGE_S3_REGION = string<br>  })</pre> | `null` | no |
